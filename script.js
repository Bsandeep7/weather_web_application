...
let updateForecast = (forecast) => {
  ...
  forecast.forEach((day) => {
    ...
    forecastitem += ` <div class="col-12 col-md-6 col-lg mb-3">
        <div class="card bg-info bg-opacity-25 weather_forecast_item">
            <div class="card-body text-center mb-3">
                <img class="img-fluid mx-auto d-block mb-3 forecast_img" src="${iconURL}" alt="Sachin">

                <h1 class="title weather_forecast_day mb-3 h1">${dayName}</h1>
                <p class="subtiltle weather_forecast_temperature mb-3 fs-1">
